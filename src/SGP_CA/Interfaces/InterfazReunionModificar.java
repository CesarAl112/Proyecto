 ...
 * @author Alberto
 */
public class InterfazReunionModificar extends JFrame implements ActionListener{
    ...
    private void inicializarComponentes(){
        ...
        horaFin.setBounds(350, 160, 160, 25);
    ...
    public void cargarDatosEdicion(JTable tabla){                       
        JTIdReunion.setText((String)tabla.getValueAt(tabla.getSelectedRow(), 0));
        JTTituloReunion.setText((String) tabla.getValueAt(tabla.getSelectedRow(), 1));
        JTHoraInicio.setText((String) tabla.getValueAt(tabla.getSelectedRow(), 2));
        JTHoraFin.setText((String) tabla.getValueAt(tabla.getSelectedRow(), 3));
        JCLider.setSelectedItem((String) tabla.getValueAt(tabla.getSelectedRow(), 4));
        JCResponsableRegistro.setSelectedItem((String) tabla.getValueAt(tabla.getSelectedRow(), 5));
        JTAsunto.setText((String) tabla.getValueAt(tabla.getSelectedRow(), 6));
        JTLugarReunion.setText((String) tabla.getValueAt(tabla.getSelectedRow(), 7));             
    }
    
    private void editarDatosReunion() throws ParseException{        
	...
	if(confirmarAccion == JOptionPane.OK_OPTION){                       
               JOptionPane.showMessageDialog(this,"los datos han sido registrados");                
                try {
                    ...
                    Logger.getLogger(InterfazReunionModificar.class.getName()).log(Level.SEVERE, null, ex);
                }
               enviarReunionEditado();
            }
        } 
    }
    
    private void enviarReunionEditado(){
        reunionDAO = new ReunionDAO();
